...
type Restriction struct {
	...
	Mode          *Restriction_Mode      `protobuf:"varint,3,opt,name=mode,enum=Restriction_Mode" json:"mode,omitempty"`
...
const file_Header_restriction_proto_rawDesc = "" +
	...
	"\x04mode\x18\x03 \x01(\x0e2\x11.Restriction.ModeR\x04mode\x12\x16\n" +
