...
type Network struct {
	...
	Type          *Network_TYPE          `protobuf:"varint,1,opt,name=type,enum=Network_TYPE" json:"type,omitempty"`
	Tf            *Network_TF            `protobuf:"varint,2,opt,name=tf,enum=Network_TF" json:"tf,omitempty"`
