...
const file_playviewreply_proto_rawDesc = "" +
	...
	"timelength\x12\"\n" +
	"\fvideoCodecid\x18\x04 \x01(\rR\fvideoCodecid\x12+\n" +
	"\n" +
	"streamList\x18\x05 \x03(\v2\v.StreamItemR\n" +
	"streamList\x12'\n" +
	"\tdashAudio\x18\x06 \x03(\v2\t.DashItemR\tdashAudio\x12 \n" +
	"\x05dolby\x18\a \x01(\v2\n" +
	".DolbyItemR\x05dolby\x12\x1e\n" +
	"\x04flac\x18\t \x01(\v2\n" +
	".DolbyItemR\x04flac\"@\n" +
	"\tDolbyItem\x12\x12\n" +
	"\x04type\x18\x01 \x01(\x05R\x04type\x12\x1f\n" +
	"\x05audio\x18\x02 \x01(\v2\t.DashItemR\x05audio\"\xfb\a\n" +
	...
	"\ttoastText\x18\x05 \x01(\tR\ttoastText\"\x85\x01\n" +
	...
	"\bclipInfo\x18\x06 \x03(\v2\t.ClipInfoR\bclipInfo\"%\n" +
	"\x05Event\x12\x1c\n" +
	"\x05shake\x18\x01 \x01(\v2\x06.ShakeR\x05shake\"\x1b\n" +
	"\x05Shake\x12\x12\n" +
	...
	"\x04size\x18\a \x01(\x04R\x04size\"\x96\x01\n" +
	"\n" +
	"StreamItem\x12+\n" +
	"\n" +
	"streamInfo\x18\x01 \x01(\v2\v.StreamInfoR\n" +
	"streamInfo\x12(\n" +
	"\tdashVideo\x18\x02 \x01(\v2\n" +
	".DashVideoR\tdashVideo\x121\n" +
	"\fsegmentVideo\x18\x03 \x01(\v2\r.SegmentVideoR\fsegmentVideo\"\xaa\x02\n" +
	"\n" +
	"StreamInfo\x12\x18\n" +
	"\aquality\x18\x01 \x01(\rR\aquality\x12\x16\n" +
	...
	"\x05limit\x18\x05 \x01(\v2\f.StreamLimitR\x05limit\x12\x18\n" +
	...
	"\tnoRexcode\x18\b \x01(\bR\tnoRexcode\"6\n" +
	"\fSegmentVideo\x12&\n" +
	"\asegment\x18\x01 \x03(\v2\f.ResponseUrlR\asegment\"G\n" +
	...
	"\x03md5\x18\x06 \x01(\tR\x03md5\"S\n" +
	"\x0eRoleAudioProto\x12A\n" +
	"\x11audioMaterialList\x18\x04 \x03(\v2\x13.AudioMaterialProtoR\x11audioMaterialList\"\x9f\x01\n" +
	...
	"personName\x12\x1f\n" +
	"\x05audio\x18\a \x03(\v2\t.DashItemR\x05audio\"\x87\x01\n" +
	"\x0fPlayDubbingInfo\x12=\n" +
	"\x0fbackgroundAudio\x18\x01 \x01(\v2\x13.AudioMaterialProtoR\x0fbackgroundAudio\x125\n" +
	"\rroleAudioList\x18\x02 \x03(\v2\x0f.RoleAudioProtoR\rroleAudioList\"I\n" +
	"\vPlayExtInfo\x12:\n" +
	"\x0fplayDubbingInfo\x18\x01 \x01(\v2\x10.PlayDubbingInfoR\x0fplayDubbingInfo\"\xe0\x01\n" +
	"\rPlayViewReply\x12(\n" +
	"\tvideoInfo\x18\x01 \x01(\v2\n" +
...
var file_playviewreply_proto_goTypes = []any{
	...
	(*ClipInfo)(nil),           // 3: ClipInfo
	(*BusinessInfo)(nil),       // 4: BusinessInfo
	(*Event)(nil),              // 5: Event
	(*Shake)(nil),              // 6: Shake
	(*DashItem)(nil),           // 7: DashItem
	(*StreamItem)(nil),         // 8: StreamItem
	(*StreamInfo)(nil),         // 9: StreamInfo
	(*DashVideo)(nil),          // 10: DashVideo
	(*SegmentVideo)(nil),       // 11: SegmentVideo
	(*StreamLimit)(nil),        // 12: StreamLimit
	(*ResponseUrl)(nil),        // 13: ResponseUrl
	(*RoleAudioProto)(nil),     // 14: RoleAudioProto
	(*AudioMaterialProto)(nil), // 15: AudioMaterialProto
	(*PlayDubbingInfo)(nil),    // 16: PlayDubbingInfo
...
var file_playviewreply_proto_depIdxs = []int32{
	...
	1,  // 3: VideoInfo.flac:type_name -> DolbyItem
	7,  // 4: DolbyItem.audio:type_name -> DashItem
	3,  // 5: BusinessInfo.clipInfo:type_name -> ClipInfo
	6,  // 6: Event.shake:type_name -> Shake
	9,  // 7: StreamItem.streamInfo:type_name -> StreamInfo
	10, // 8: StreamItem.dashVideo:type_name -> DashVideo
	11, // 9: StreamItem.segmentVideo:type_name -> SegmentVideo
	12, // 10: StreamInfo.limit:type_name -> StreamLimit
	13, // 11: SegmentVideo.segment:type_name -> ResponseUrl
	15, // 12: RoleAudioProto.audioMaterialList:type_name -> AudioMaterialProto
	7,  // 13: AudioMaterialProto.audio:type_name -> DashItem
	15, // 14: PlayDubbingInfo.backgroundAudio:type_name -> AudioMaterialProto
	14, // 15: PlayDubbingInfo.roleAudioList:type_name -> RoleAudioProto
	16, // 16: PlayExtInfo.playDubbingInfo:type_name -> PlayDubbingInfo
	0,  // 17: PlayViewReply.videoInfo:type_name -> VideoInfo
	2,  // 18: PlayViewReply.playConf:type_name -> PlayAbilityConf
	4,  // 19: PlayViewReply.business:type_name -> BusinessInfo
	5,  // 20: PlayViewReply.event:type_name -> Event
	17, // 21: PlayViewReply.playExtInfo:type_name -> PlayExtInfo
