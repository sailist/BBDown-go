...
type PlayViewReq struct {
	...
	PreferCodecType *PlayViewReq_CodeType  `protobuf:"varint,12,opt,name=preferCodecType,enum=PlayViewReq_CodeType" json:"preferCodecType,omitempty"`
...
const file_Payload_playviewreq_proto_rawDesc = "" +
	...
	"\tfromSpmid\x18\n" +
	" \x01(\tR\tfromSpmid\x12$\n" +
	"\rteenagersMode\x18\v \x01(\x05R\rteenagersMode\x12?\n" +
	"\x0fpreferCodecType\x18\f \x01(\x0e2\x15.PlayViewReq.CodeTypeR\x0fpreferCodecType\x12\x1c\n" +
